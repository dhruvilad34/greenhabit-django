...
from .forms import UserProfileForm, GoalForm, BlogPostForm
...
def home(request):
    ...
    recent_goals = Goal.objects.order_by('-id')[:3]
...
def create_blog(request):
    if request.method == 'POST':
        ...
        form = BlogPostForm()
    return render(request, 'tracker/create_blog.html', {'form': form})
